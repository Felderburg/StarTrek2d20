 ...
 * in play.
 */
class NotKlingonPrerequisite implements ICharacterPrerequisite {
    isPrerequisiteFulfilled(character: Character): boolean {
        if (new SourceCharacterPrerequisite(Source.KlingonCore).isPrerequisiteFulfilled(character)) {
            return !(new KlingonCharacterPrerequisite().isPrerequisiteFulfilled(character));
        } else {
            return true;
        }
    }
...
class AdultPrerequisite implements ICharacterPrerequisite {
    isPrerequisiteFulfilled(character: Character): boolean {
...
class CivilianPrerequisite implements ICharacterPrerequisite {
    ...
    isPrerequisiteFulfilled(character: Character) {
        if (new SourceCharacterPrerequisite(Source.SciencesDivision, Source.PlayersGuide, Source.KlingonCore).isPrerequisiteFulfilled(character)) {
...
class ChildPrerequisite implements ICharacterPrerequisite {
    isPrerequisiteFulfilled(character: Character): boolean {
...
class NotTalentPrerequisite implements ICharacterPrerequisite {
...
export class RoleModel {
    ...
    constructor(id: Role, name: string, description: string, department: Department, ability: string, ...prerequisites: ICharacterPrerequisite[]) {
        this.id = id;
        this.name = name;
    ...
    get isKlingon() {
        let prerequisites = this.prerequisites.filter(p => p instanceof KlingonCharacterPrerequisite);
    ...
    isKlingonRole() {
        return this.prerequisites.filter(p => p instanceof KlingonCharacterPrerequisite)?.length > 0;
    }
}
...
export class RolesHelper {
    ...
    private _roles: RoleModel[] = [
        new RoleModel(
            ...
            new SourceCharacterPrerequisite(Source.Core, Source.Core2ndEdition),
            new NotCharacterPrerequisite(new CareersCharacterPrerequisite(Career.Young)),
            new NotCharacterPrerequisite(new EnlistedCharacterPrerequisite()),
            new NotKlingonPrerequisite(),
            new MilitaryPrerequisite(),
            new NotCharacterPrerequisite(new CadetPrerequisite())),
        new RoleModel(
        ...
        new RoleModel(
            ...
            new NotCharacterPrerequisite(
                new AllOfCharacterPrerequisite(
                    new SourceCharacterPrerequisite(Source.TricorderSet),
                    new AnyEraCharacterPrerequisite(Era.OriginalSeries)
                )),
            new SourceCharacterPrerequisite(Source.Core, Source.Core2ndEdition),
            new NotKlingonPrerequisite(),
            new NotTalentPrerequisite("Advanced Team Dynamics"),
        ...
        new RoleModel(
            ...
            new SourceCharacterPrerequisite(Source.TricorderSet, Source.Core2ndEdition),
            new NotKlingonPrerequisite(),
            new NotTalentPrerequisite("Advanced Team Dynamics"),
            new MilitaryPrerequisite()),
        new RoleModel(
        ...
        new RoleModel(
            ...
            new SourceCharacterPrerequisite(Source.CommandDivision),
            new NotCharacterPrerequisite(new SourceCharacterPrerequisite(Source.Core2ndEdition)),
            new NotKlingonPrerequisite(),
        ...
        new RoleModel(
            ...
            new SourceCharacterPrerequisite(Source.SciencesDivision),
            new NotTalentPrerequisite("Advanced Team Dynamics"),
            new NotKlingonPrerequisite(),
        ...
        new RoleModel(
            ...
            Department.Command,
            "The commanding officer may spend a point of Determination to grant any other character they can communicate with one point of Determination; this does not have to be linked to a value.",
            new SourceCharacterPrerequisite(Source.KlingonCore),
        ...
        new RoleModel(
            ...
            new AnyOfCharacterPrerequisite(
                new AllOfCharacterPrerequisite(
                    new AnyEraCharacterPrerequisite(Era.Enterprise),
                    new CharacterTypePrerequisite(CharacterType.Starfleet)),
                new AllOfCharacterPrerequisite(
                    new SourceCharacterPrerequisite(Source.FederationKlingonWar),
                    new CharacterTypePrerequisite(CharacterType.Starfleet)),
        ...
        new RoleModel(
            ...
            new NotTalentPrerequisite("Advanced Team Dynamics"),
            new SourceCharacterPrerequisite(Source.PlayersGuide, Source.Core2ndEdition),
            new AdultPrerequisite()),
        new RoleModel(
            Role.ShipsCookOrChef,
            "Chef",
        ...
        new RoleModel(
            ...
            new NotTalentPrerequisite("Advanced Team Dynamics"),
            new SourceCharacterPrerequisite(Source.FederationKlingonWar, Source.Core2ndEdition),
            new AdultPrerequisite()),
