export class AgeLifepathOptions {
  ...
  constructor(
    decreaseAttributes: number = 0,
    decreaseDisciplines: number = 0,
    numberOfFocuses: number = 3,
    focusText = '',
  ) {
...
export class Age {
  ...
  constructor(
    ...
    attributeSum: number,
    departmentSum: number,
    options: AgeLifepathOptions = new AgeLifepathOptions(),
    description: string = '',
  ) {
    this.name = name;
...
class _AgeHelper {
  private ages: Age[] = [
    ...
    new Age(
      ...
      52,
      12,
      new AgeLifepathOptions(
        2,
        2,
        1,
        'You select one focus. This should reflect your areas of interest, one of your hobbies or the school subject you excel at.',
      ),
    ...
    new Age(
      ...
      new AgeLifepathOptions(
        ...
        1,
        2,
        'You select two focuses. These should reflect your areas of interest, your hobbies or the school subjects you excel at.',
      ),
