...
export class EarlyOutlookModel {
  ...
  constructor(
    ...
    name: string,
    description: string,
    attributesAcceptPlus2: Attribute,
    attributesAcceptPlus1: Attribute,
    attributesRebelPlus2: Attribute,
    attributesRebelPlus1: Attribute,
    disciplines: Department[],
    focusDescription: string,
    focusSuggestions: string[],
    keyPrefix?: string,
...
class Upbringings {
  ...
  private _alternateUpbringings: EarlyOutlookModel[] = [
    ...
    new EarlyOutlookModel(
      ...
      [
        'Hand-to-Hand Combat (may rename as a specific Martial Art)',
        'Hand Phasers',
        'Survival',
        'Threat Awareness',
        'Emergency Medicine',
    ...
    new EarlyOutlookModel(
      ...
      [
        ...
        'Genetics',
        'Holoprogramming',
        'Music (may rename as a particular genre or instrument)',
        'Persuasion',
        'Philosophy',
        'Politics',
        'Trade & Finance',
  ...
  private _castes: EarlyOutlookModel[] = [
    new EarlyOutlookModel(
      ...
      [
        'Composure',
        'Hand-to-Hand Combat (may be renamed to a particular style or weapon)',
        'Disruptors',
        'Intimidation',
        'Military History',
        'Small Craft',
