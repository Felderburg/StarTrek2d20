...
import { AllOfCharacterPrerequisite, AnyEraCharacterPrerequisite, AnyOfCharacterPrerequisite, CareersCharacterPrerequisite, CharacterTypePrerequisite, EnlistedCharacterPrerequisite, ICharacterPrerequisite, KlingonCharacterPrerequisite, NotCharacterPrerequisite, NotRolesCharacterPrerequisite, OfficerCharacterPrerequisite, SourceCharacterPrerequisite } from './characterPrerequisite';
...
export class RankModel {
    ...
    constructor(id: Rank|null, name: string, level: string, prerequisites: ICharacterPrerequisite[], abbreviation?: string) {
        this.id = id;
        this.level = level;
    ...
    get isEnlisted() {
        return this.prerequisites.filter(p => p instanceof EnlistedCharacterPrerequisite).length > 0;
    }
    ...
    private _ranks: RankModel[] = [
        new RankModel(
            ...
            [
                ...
                new AnyOfCharacterPrerequisite(
                    ...
                    new AlliedMilitaryCharacterPrerequisite(AlliedMilitaryType.AndorianImperialGuard, AlliedMilitaryType.TalarianMilitia)
                )
            ],
            "Capt."),
        new RankModel(
            ...
            [
                ...
                new CareersCharacterPrerequisite(Career.Experienced, Career.Veteran),
                new NotRolesCharacterPrerequisite([Role.Admiral]),
                new NotCharacterPrerequisite(new AlliedMilitaryCharacterPrerequisite(AlliedMilitaryType.Maco, AlliedMilitaryType.CardassianUnion, AlliedMilitaryType.FerengiMilitary))
            ],
            "Cmdr."),
        new RankModel(
            Rank.LtCommander,
            ...
            [
                new OfficerCharacterPrerequisite(),
                new CareersCharacterPrerequisite(Career.Experienced, Career.Veteran),
                new NotRolesCharacterPrerequisite([Role.Admiral, Role.CommandingOfficer]),
                new AnyOfCharacterPrerequisite(
                    new CharacterTypePrerequisite(CharacterType.Starfleet),
                    new AlliedMilitaryCharacterPrerequisite(AlliedMilitaryType.TalarianMilitia)
                )
            ],
            "LCdr."),
        new RankModel(
            ...
            [
                ...
                new AnyOfCharacterPrerequisite(
                    ...
                    new AlliedMilitaryCharacterPrerequisite(AlliedMilitaryType.KlingonDefenceForce, AlliedMilitaryType.RomulanStarEmpire,
        ...
        new RankModel(
            ...
            [
                new OfficerCharacterPrerequisite(),
                new CareersCharacterPrerequisite(Career.Young, Career.Experienced),
                new NotRolesCharacterPrerequisite([Role.ExecutiveOfficer, Role.ChiefMedicalOfficer, Role.ChiefOfSecurity, Role.ChiefEngineer, Role.CommandingOfficer]),
                new AnyOfCharacterPrerequisite(
                    new CharacterTypePrerequisite(CharacterType.Starfleet, CharacterType.KlingonWarrior),
                    new AlliedMilitaryCharacterPrerequisite(AlliedMilitaryType.KlingonDefenceForce, AlliedMilitaryType.TalarianMilitia)),
            ],
            "Ens."),
        new RankModel(
        ...
        new RankModel(
            ...
            [
                new OfficerCharacterPrerequisite(),
                new CareersCharacterPrerequisite(Career.Veteran),
                new SourceCharacterPrerequisite(Source.CommandDivision, Source.PlayersGuide),
                new RolesPrerequisite([Role.Admiral]),
                new AnyOfCharacterPrerequisite(
                    new CharacterTypePrerequisite(CharacterType.Starfleet),
                    new AlliedMilitaryCharacterPrerequisite(AlliedMilitaryType.RomulanStarEmpire)
                )
            ],
            "Adm."),
        new RankModel(
        ...
        new RankModel(
            ...
            [
                new OfficerCharacterPrerequisite(),
                new CareersCharacterPrerequisite(Career.Experienced, Career.Veteran),
                new AnyEraCharacterPrerequisite(Era.NextGeneration, Era.PicardProdigy, Era.Discovery32),
                new SourceCharacterPrerequisite(Source.CommandDivision, Source.PlayersGuide),
                new RolesPrerequisite([Role.Admiral]),
                new CharacterTypePrerequisite(CharacterType.Starfleet)
            ],
        ...
        new RankModel(
            ...
            "Civilian", "",
            [
                new AnyOfCharacterPrerequisite(new RolesPrerequisite([Role.DiplomaticAttache]), new TrackPrerequisite(Track.Laborer))
            ]),
        new RankModel(
            Rank.Sergeant,
            "Sergeant (bu')", "E5",
        ...
        new RankModel(
            ...
            [
                ...
                new AnyOfCharacterPrerequisite(
                    new CharacterTypePrerequisite(CharacterType.KlingonWarrior),
                    new AlliedMilitaryCharacterPrerequisite(AlliedMilitaryType.Maco, AlliedMilitaryType.BajoranMilitia,
        ...
        new RankModel(
            ...
            [
                new OfficerCharacterPrerequisite(),
                new SourceCharacterPrerequisite(Source.PlayersGuide),
                new AlliedMilitaryCharacterPrerequisite(AlliedMilitaryType.BajoranMilitia)
            ],
            "Lt."),
        new RankModel(
        ...
        new RankModel(
            ...
            [
                ...
                new SourceCharacterPrerequisite(Source.PlayersGuide),
                new CareersCharacterPrerequisite(Career.Veteran),
                new AlliedMilitaryCharacterPrerequisite(AlliedMilitaryType.CardassianUnion)
            ]),
        new RankModel(
            Rank.Legate,
            "Legate", "O8",
        ...
        new RankModel(
            ...
            [
                new EnlistedCharacterPrerequisite(),
                new SourceCharacterPrerequisite(Source.PlayersGuide),
                new AlliedMilitaryCharacterPrerequisite(AlliedMilitaryType.AndorianImperialGuard)
            ]),
        ...
        new RankModel(
            ...
            [
                new OfficerCharacterPrerequisite(),
                new SourceCharacterPrerequisite(Source.PlayersGuide),
                new AlliedMilitaryCharacterPrerequisite(AlliedMilitaryType.RomulanStarEmpire, AlliedMilitaryType.VulcanHighCommand)
            ]),
        new RankModel(
            Rank.SubLieutenant,
            "Sub-Lieutenant", "O2",
        ...
        new RankModel(
            ...
            [
                ...
                new SourceCharacterPrerequisite(Source.PlayersGuide),
                new CareersCharacterPrerequisite(Career.Veteran),
                new AlliedMilitaryCharacterPrerequisite(AlliedMilitaryType.VulcanHighCommand)
            ]),
        new RankModel(
            Rank.FleetCommander,
            "Fleet Commander", "O6",
        ...
        new RankModel(
            ...
            [
                new OfficerCharacterPrerequisite(),
                new AlliedMilitaryCharacterPrerequisite(AlliedMilitaryType.FerengiMilitary)
            ],
            "DaiMon"),
        new RankModel(
            Rank.Adhar,
