...
export class AttributeImprovementRule {
  ...
  describe() {
    return (
      'At least one point must be spent on ' + this.describeAttributes() + '.'
    );
  }
  ...
  describeAttributes() {
    ...
    this.attributes.forEach((a, i) => {
      result += i === 0 ? Attribute[a] : ' or ' + Attribute[a];
    });
    return result;
  }
}
...
export class DepartmentImprovementRule {
  ...
  describe() {
    if (this.type === ImprovementRuleType.MAY_DECREMENT_ONE) {
      ...
      return (
        'Points must be distributed to ' + this.describeDepartments() + '.'
      );
    }
  }
  ...
  describeDepartments() {
    ...
    this.skills.forEach((s, i) => {
      result += i === 0 ? Department[s] : ' and ' + Department[s];
    });
    return result;
  }
}
...
export class TrackModel {
  ...
  constructor(
    ...
    majorDisciplines: Department[],
    otherDisciplines: Department[],
    focuses: string[] | TrackFocuses,
    attributes?: AttributeImprovementRule,
    skillsRule?: DepartmentImprovementRule,
    ...
    this.focuses =
      focuses instanceof TrackFocuses
        ? (focuses as TrackFocuses)
        : new TrackFocuses(focuses as string[]);
...
export class TracksHelper {
  ...
  private _alliedMilitaryTracks: TrackModel[] = [
    new TrackModel(
      ...
      new AttributeImprovementRule(
        ImprovementRuleType.AT_LEAST_ONE,
        Attribute.Daring,
      ),
      undefined,
      true,
    ...
    new TrackModel(
      ...
      undefined,
      new DepartmentImprovementRule(
        ImprovementRuleType.MUST_INCLUDE_ALL,
        Department.Command,
        Department.Security,
      ),
    ),
  ...
  private _civilianTracks: TrackModel[] = [
    ...
    new TrackModel(
      ...
      [
        ...
        'History',
        'Philosophy',
        'or something related to your role in public service',
      ],
      new AttributeImprovementRule(
        ImprovementRuleType.AT_LEAST_ONE,
        Attribute.Insight,
