...
export class DepartmentImprovementRule {
    skills: Department[];
    type: ImprovementRuleType;

    constructor(type: ImprovementRuleType, ...skills: Department[]) {
        this.type = type;
        this.skills = skills;
    }
    ...
    describe() {
        if (this.type === ImprovementRuleType.MAY_DECREMENT_ONE) {
            ...
            return "Points must be distributed to " + this.describeDepartments() + ".";
        }
    }

    describeDepartments() {
        let result = this.skills.length > 1 ? "each of " : "";
        this.skills.forEach((s, i) => { result += (i === 0) ? Department[s] : (" and " + Department[s])});
        return result;
    }
}
...
export class TracksHelper {
    ...
    private _tracks: TrackModel[] = [
        new TrackModel(
            ...
            [Department.Engineering, Department.Medicine, Department.Science, Department.Security],
        ...
        new TrackModel(
            ...
            [Department.Engineering, Department.Security],
            [Department.Command, Department.Conn, Department.Medicine, Department.Science],
        ...
        new TrackModel(
            ...
            [Department.Command, Department.Conn, Department.Engineering, Department.Security],
        ...
        new TrackModel(
            ...
            [Department.Science],
            [Department.Medicine, Department.Engineering],
            ["Anthropology", "Astrophysics", "Botany", "Computers", "Cybernetics", "Emergency Medicine", "Exo-tectonics", "Genetics", "Geology", "Infectious Diseases", "Linguistics", "Physics", "Psychiatry", "Quantum Mechanics", "Trauma Surgery", "Virology", "Warp Field Dynamics", "Xenobiology"],
            undefined,
            undefined,
            false,
    ...
    private _klingonTracks: TrackModel[] = [
        ...
        new TrackModel(
            ...
            [Department.Command, Department.Engineering, Department.Medicine, Department.Science],
        ...
        new TrackModel(
            ...
            [Department.Engineering, Department.Science],
            [Department.Command, Department.Conn, Department.Medicine, Department.Security],
    ...
    private _alliedMilitaryTracks: TrackModel[] = [
        new TrackModel(
            ...
            [Department.Security],
            [Department.Conn, Department.Engineering, Department.Medicine, Department.Science, Department.Command],
        ...
        new TrackModel(
            ...
            undefined,
            new DepartmentImprovementRule(ImprovementRuleType.MUST_INCLUDE_ALL, Department.Command, Department.Security)
        ),
        new TrackModel(
            Track.IntelligenceTraining,
            ...
            [Department.Conn, Department.Security, Department.Command, Department.Engineering, Department.Medicine, Department.Science],
            [],
            ...
            new DepartmentImprovementRule(ImprovementRuleType.MUST_INCLUDE_ALL, Department.Security)
        ),
        new TrackModel(
            ...
            [Department.Security],
            [Department.Command, Department.Conn,Department.Engineering, Department.Medicine, Department.Science],
