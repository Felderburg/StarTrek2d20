...
export class SpeciesAbilityList {
    ...
    private items: { [id: number] : SpeciesAbility} = {
        ...
        [Species.Caitian]: new SpeciesAbility(Species.Caitian),
        [Species.Chameloid]: new SpeciesAbility(Species.Chameloid),
        [Species.Changeling]: new SpeciesAbility(Species.Changeling),
