...
export class BorgImplants {
  ...
  readonly implants: Implant[] = [
    new Implant(
      'Adaptive shielding',
      BorgImplantType.AdaptiveShielding,
    ...
    new Implant(
      ...
      BorgImplantType.CardiopulmonaryStrengthener,
    ...
    new Implant(
      ...
      BorgImplantType.CorticalArrayBioSyntheticGland,
    ...
    new Implant(
      ...
      BorgImplantType.CorticalArrayCorticalNode,
    ...
    new Implant(
      ...
      BorgImplantType.CorticalArrayInterlinkNode,
    ...
    new Implant(
      ...
      BorgImplantType.CorticalArrayNeuralSubspaceTranceiver,
    ...
    new Implant(
      ...
      BorgImplantType.CyberneticArmEngineering,
    ...
    new Implant(
      'Exo-plating',
      BorgImplantType.ExoPlating,
      'Grants the character Resistance 2.',
    ),
    new Implant(
      'Ocular sensory enhancer',
      BorgImplantType.OcularSensoryEnhancer,
