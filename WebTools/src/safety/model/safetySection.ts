...
export class SafetySection {
  ...
  get localizedName() {
    return i18next.t(
      makeKey('SafetySectionType.', SafetySectionType[this.type]),
    );
  }
...
export class SafetySections {
  ...
  sections = [
    new SafetySection(
      SafetySectionType.Violence,
      'dismemberment',
      'gore',
      'massDestructionGenocide',
      'harmToAnimals',
      'harmToChildren',
      'hateCrimes',
    ),
    new SafetySection(
      SafetySectionType.GameplayMechanics,
      'traitorMechanicsPvP',
    ),
    new SafetySection(
      SafetySectionType.Hatred,
      'speciesHate',
      'homophobia',
      'racism',
    ...
    new SafetySection(
      SafetySectionType.Helplessness,
      'entrapment',
      'grief',
    ...
    new SafetySection(
      SafetySectionType.WarCrimes,
      'biologicalWeapons',
      'desecrationOfBodies',
      'execution',
      'forcedScientificExperiments',
      'murderOfNonCombatants',
      'torture',
    ),
  ];
