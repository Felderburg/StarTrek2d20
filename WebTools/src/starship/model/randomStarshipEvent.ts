...
const majorEvents = {
  ...
  2256: ['Battle of the Binary Stars', 'Federation-Klingon War'],
  2257: [
    'The Battle of Axanar',
    'The Attack on Starbase 12',
    'The Attack on Starbase 19',
    'The Attack on Starbase 22',
  ],
...
export const randomStarshipEvent = (
  spaceframe: IServiceYearProvider,
  currentYear: number,
) => {
  const events = [];
