...
> {
  render() {
    const { t } = this.props;
    const missionProfiles = MissionPodHelper.instance()
      .getMissionPods(this.props.starship)
      .map((p, i) => {
        ...
        return (
          <tbody key={i}>
            <tr>
              <td className="selection-header" rowSpan={4}>
                {p.localizedName}
              </td>
              <td
              ...
              >
                {formatAsDelta(p.systems[System.Comms])}
              </td>
              <td
                className="d=none d-md-table-cell"
                style={{ textAlign: 'right' }}
              ...
              <td
                ...
                style={{ textAlign: 'center' }}
              >
                {formatAsDelta(p.systems[System.Engines])}
              </td>
              <td
                className="d=none d-md-table-cell"
                style={{ textAlign: 'right' }}
              ...
              <td
                ...
                style={{ textAlign: 'center' }}
              >
                {formatAsDelta(p.systems[System.Structure])}
              </td>
              <td
                className="d=none d-md-table-cell"
                style={{ verticalAlign: 'top', paddingLeft: '0.75rem' }}
                rowSpan={4}
              >
                {talents}
              </td>
              <td rowSpan={4}>
                <CheckBox
                  isChecked={
                    this.props.initialSelection != null &&
                    this.props.initialSelection.id === p.id
                  }
                  text=""
                  value={p.id}
                  onChanged={(val) => {
                    this.props.onSelection(p);
                  }}
                />
              </td>
            </tr>
            <tr>
              ...
              <td
                ...
                style={{ textAlign: 'center' }}
              >
                {formatAsDelta(p.systems[System.Computer])}
              </td>
              <td
                className="d=none d-md-table-cell"
                style={{ textAlign: 'right' }}
              ...
              <td
                ...
                style={{ textAlign: 'center' }}
              >
                {formatAsDelta(p.systems[System.Sensors])}
              </td>
              <td
                className="d=none d-md-table-cell"
                style={{ textAlign: 'right' }}
              ...
              <td
                ...
                style={{ textAlign: 'center' }}
              >
                {formatAsDelta(p.systems[System.Weapons])}
              </td>
            </tr>
            <tr>
              <td
              ...
              <td
                ...
                style={{ textAlign: 'center' }}
              >
                {formatAsDelta(p.departments[Department.Command])}
              </td>
              <td
                className="d=none d-md-table-cell"
                style={{ textAlign: 'right' }}
              ...
              <td
                ...
                style={{ textAlign: 'center' }}
              >
                {formatAsDelta(p.departments[Department.Security])}
              </td>
              <td
                className="d=none d-md-table-cell"
                style={{ textAlign: 'right' }}
              ...
              <td
                ...
                style={{ textAlign: 'center' }}
              >
                {formatAsDelta(p.departments[Department.Science])}
              </td>
            </tr>
            <tr>
              <td
              ...
              <td
                ...
                style={{ textAlign: 'center' }}
              >
                {formatAsDelta(p.departments[Department.Conn])}
              </td>
              <td
                className="d=none d-md-table-cell"
                style={{ textAlign: 'right' }}
              ...
              <td
                ...
                style={{ textAlign: 'center' }}
              >
                {formatAsDelta(p.departments[Department.Engineering])}
              </td>
              <td
                className="d=none d-md-table-cell"
                style={{ textAlign: 'right' }}
              ...
              <td
                ...
                style={{ textAlign: 'center' }}
              >
                {formatAsDelta(p.departments[Department.Medicine])}
              </td>
            </tr>
          </tbody>
        );
