...
> {
  render() {
    ...
    const missionProfiles = MissionProfiles.instance
      ...
      .map((m, i) => {
        ...
        const notes =
          m.notes !== '' ? <div className="p-1">{m.notes}</div> : undefined;
              ...
              <td className="d-none d-md-table-cell">
                ...
                >
                  <StatView
                    ...
                    value={m.departments[Department.Command]}
                    className="col mb-1"
                    showZero={true}
                  />
                  <StatView
                    name={t('Construct.department.security')}
                    value={m.departments[Department.Security]}
                    className="col mb-1"
                    showZero={true}
                  />
                  <StatView
                    name={t('Construct.department.science')}
                    value={m.departments[Department.Science]}
                    className="col mb-1"
                    showZero={true}
                  />
                  <StatView
                    name={t('Construct.department.conn')}
                    value={m.departments[Department.Conn]}
                    className="col mb-1"
                    showZero={true}
                  />
                  <StatView
                    name={t('Construct.department.engineering')}
                    value={m.departments[Department.Engineering]}
                    className="col mb-1"
                    showZero={true}
                  />
                  <StatView
                    name={t('Construct.department.medicine')}
                    value={m.departments[Department.Medicine]}
                    className="col mb-1"
                    showZero={true}
                  />
                </div>
              ...
              <td>
                <CheckBox
                  isChecked={
                    ...
                    this.props.initialSelection.id === m.id
                  }
                  text=""
                  value={m.id}
                  onChanged={() => {
                    this.props.onSelection(m);
                  }}
                />
              </td>
            </tr>
