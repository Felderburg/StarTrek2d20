...
export class BaseSimpleStarshipPage extends React.Component<
  ISimpleStarshipPageProperties,
  {}
> {
  render() {
    const { t } = this.props;
          ...
          <div className="col mb-3">
            ...
            <div className="stats-row pt-2">
              <StatControl
                ...
                value={this.props.starship.scale}
                showIncrease={this.canIncreaseScale()}
                showDecrease={this.canDecreaseScale()}
                onIncrease={() => {
                  this.setScale(1);
                }}
                onDecrease={() => {
        ...
        <section className="my-5">
          ...
          <div className="stats-row mt-4">
            <StatControl
              ...
              value={this.getSystem(System.Comms)}
              showIncrease={this.canIncreaseSystem(System.Comms)}
              showDecrease={this.canDecreaseSystem(System.Comms)}
              onIncrease={() => {
                this.setSystem(System.Comms, 1);
              }}
              onDecrease={() => {
                this.setSystem(System.Comms, -1);
              }}
            ...
            <StatControl
              ...
              value={this.getSystem(System.Engines)}
              showIncrease={this.canIncreaseSystem(System.Engines)}
              showDecrease={this.canDecreaseSystem(System.Engines)}
              onIncrease={() => {
                this.setSystem(System.Engines, 1);
              }}
              onDecrease={() => {
                this.setSystem(System.Engines, -1);
              }}
            ...
            <StatControl
              ...
              value={this.getSystem(System.Structure)}
              showIncrease={this.canIncreaseSystem(System.Structure)}
              showDecrease={this.canDecreaseSystem(System.Structure)}
              onIncrease={() => {
                this.setSystem(System.Structure, 1);
              }}
              onDecrease={() => {
                this.setSystem(System.Structure, -1);
              }}
          ...
          <div className="stats-row">
            <StatControl
              ...
              value={this.getSystem(System.Computer)}
              showIncrease={this.canIncreaseSystem(System.Computer)}
              showDecrease={this.canDecreaseSystem(System.Computer)}
              onIncrease={() => {
                this.setSystem(System.Computer, 1);
              }}
              onDecrease={() => {
                this.setSystem(System.Computer, -1);
              }}
            ...
            <StatControl
              ...
              value={this.getSystem(System.Sensors)}
              showIncrease={this.canIncreaseSystem(System.Sensors)}
              showDecrease={this.canDecreaseSystem(System.Sensors)}
              onIncrease={() => {
                this.setSystem(System.Sensors, 1);
              }}
              onDecrease={() => {
                this.setSystem(System.Sensors, -1);
              }}
            ...
            <StatControl
              ...
              value={this.getSystem(System.Weapons)}
              showIncrease={this.canIncreaseSystem(System.Weapons)}
              showDecrease={this.canDecreaseSystem(System.Weapons)}
              onIncrease={() => {
                this.setSystem(System.Weapons, 1);
              }}
              onDecrease={() => {
                this.setSystem(System.Weapons, -1);
              }}
        ...
        <section className="my-5">
          ...
          <div className="stats-row mt-4">
            <StatControl
              ...
              value={this.getDepartment(Department.Command)}
              showIncrease={this.canIncreaseDepartment(Department.Command)}
              showDecrease={this.canDecreaseDepartment(Department.Command)}
              onIncrease={() => {
                this.setDepartment(Department.Command, 1);
              }}
              onDecrease={() => {
                this.setDepartment(Department.Command, -1);
              }}
            ...
            <StatControl
              ...
              value={this.getDepartment(Department.Security)}
              showIncrease={this.canIncreaseDepartment(Department.Security)}
              showDecrease={this.canDecreaseDepartment(Department.Security)}
              onIncrease={() => {
                this.setDepartment(Department.Security, 1);
              }}
              onDecrease={() => {
                this.setDepartment(Department.Security, -1);
              }}
            ...
            <StatControl
              ...
              value={this.getDepartment(Department.Science)}
              showIncrease={this.canIncreaseDepartment(Department.Science)}
              showDecrease={this.canDecreaseDepartment(Department.Science)}
              onIncrease={() => {
                this.setDepartment(Department.Science, 1);
              }}
              onDecrease={() => {
                this.setDepartment(Department.Science, -1);
              }}
          ...
          <div className="stats-row">
            <StatControl
              ...
              value={this.getDepartment(Department.Conn)}
              showIncrease={this.canIncreaseDepartment(Department.Conn)}
              showDecrease={this.canDecreaseDepartment(Department.Conn)}
              onIncrease={() => {
                this.setDepartment(Department.Conn, 1);
              }}
              onDecrease={() => {
                this.setDepartment(Department.Conn, -1);
              }}
            ...
            <StatControl
              ...
              value={this.getDepartment(Department.Engineering)}
              showIncrease={this.canIncreaseDepartment(Department.Engineering)}
              showDecrease={this.canDecreaseDepartment(Department.Engineering)}
              onIncrease={() => {
                this.setDepartment(Department.Engineering, 1);
              }}
              onDecrease={() => {
                this.setDepartment(Department.Engineering, -1);
              }}
            ...
            <StatControl
              ...
              value={this.getDepartment(Department.Medicine)}
              showIncrease={this.canIncreaseDepartment(Department.Medicine)}
              showDecrease={this.canDecreaseDepartment(Department.Medicine)}
              onIncrease={() => {
                this.setDepartment(Department.Medicine, 1);
              }}
              onDecrease={() => {
                this.setDepartment(Department.Medicine, -1);
              }}
