...
export class Portrait2eStationSheet extends BaseNonForm2eSheet {
    ...
    writeThreeColumnDerivedStats(page: PDFPage, station: Station, previousParagraph: Paragraph, colour: SimpleColor) {
        ...
        scaleParagraph.append(i18next.t("Construct.other.scale").toLocaleUpperCase() + ": ", new FontSpecification(this.boldFont, 9),
            colour);
        scaleParagraph.append(station.scale, new FontSpecification(this.textFont, 9));
    ...
    async populate(pdf: PDFDocument, construct: Construct) {
        ...
        SpaceframeOutline.draw(pdf, new SheetOutlineOptions(new XYLocation(322, 75), colour.asPdfRbg(), 1.3, 2.5), station);
        ...
        */
        ...
        [System.Comms, System.Engines, System.Structure, System.Computer, System.Sensors, System.Weapons].forEach((s, i) => {
            ...
            this.writeLabel(page, "" + station.systems[s], this.valueBlock(column), new FontSpecification(this.boldFont, statFontSize),
                tealColour2e);
        ...
        [Department.Command, Department.Engineering, Department.Medicine, Department.Conn, Department.Security, Department.Science].forEach((d, i) => {
            ...
            this.writeLabel(page, "" + station.departments[d], this.valueBlock(column), new FontSpecification(this.boldFont, statFontSize),
                labelColourProvider(construct.era, key));
        });
        ...
        let remainingColumn = this.writeAttacks(page, station,
            column.bottomAfter(
        ...
        let bottomOfShields = this.writeShieldsBoxes(page, pdf.getForm(), station, remainingColumn);
