...
export class GeneratedTngPortraitCharacterSheet extends BaseTNGGeneratedCharacterSheet {
  ...
  writeStress(
    ...
    super.writeStress(
      ...
      page,
      character,
      GeneratedTngPortraitCharacterSheet.lightPurpleColour,
    );
  }
  ...
  writeTitle(page: PDFPage) {
    ...
    const fontSize = this.determineIdealFontWidth(
      [text],
      GeneratedTngPortraitCharacterSheet.headingColumn.width,
      25,
      18,
      this.headingFont,
    );
    ...
    page.drawText(text, {
      x:
        GeneratedTngPortraitCharacterSheet.headingColumn.start.x +
        GeneratedTngPortraitCharacterSheet.headingColumn.width -
        width,
