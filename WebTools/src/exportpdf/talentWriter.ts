...
export class ReadableTalentModel {
  ...
  x?: number;
  selection?:
    string | SpecialWeapon | AttackType | PropulsionSystemType | OtherSelection;
...
export class TalentWriter {
  ...
  constructor(
    ...
    fonts: FontLibrary,
    version: number = 1,
    headingColour: SimpleColor = SimpleColor.from('#000000'),
  ...
  async writeTalents(
    talents: (ReadableTalentModel | RoleModel | SpeciesAbilityAndOptions)[],
    column: Column,
    fontSize: number = 9,
    nameFontSize?: number,
    indent: number = 0,
  ...
  private async writeTalentsInternal(
    talents: (ReadableTalentModel | RoleModel | SpeciesAbilityAndOptions)[],
    column: Column,
    fontSize: number = 9,
    nameFontSize?: number,
      ...
      if (paragraph) {
        if (talent instanceof RoleModel) {
          paragraph.append(
            ...
            new FontOptions(nameFontSize, FontType.Bold),
            this.headingColour,
          );
          paragraph.append(
            this.version === 1
              ? talent.localizedAbility
              : talent.localizedAbility2e,
          ...
          talent.options?.implants?.forEach((type) => {
            ...
            if (paragraph) {
              ...
              paragraph.append(
                ...
                new FontOptions(fontSize, FontType.Bold),
              );
              paragraph.append(
                this.version === 1
          ...
          if (talent.options?.choice != null) {
            ...
            if (paragraph) {
              ...
              paragraph.indent(indent + 10);
              paragraph.append(
                talent.ability.getChoiceName(talent.options?.choice) + ': ',
                new FontOptions(fontSize, FontType.Bold),
              );
              paragraph.append(
                talent.ability.getChoiceDescription(talent.options?.choice),
                new FontOptions(fontSize),
              );
            }
          }
          ...
          let description =
            this.version === 1
              ? talent.talent.localizedDescription
              : talent.talent.localizedDescription2e;
          ...
          if (talent.talent.isXQualified) {
            if (talent.x != null) {
              ...
              talentName =
                ...
                talent.x +
                talentName.substring(xLocation + 2);
          ...
          if (
            talent.talent.name === TALENT_NAME_BORG_IMPLANTS &&
            talent.implants?.length
          ) {
            ...
            talent.talent.name === TALENT_NAME_UNTAPPED_POTENTIAL &&
            talent.attributes?.length
          ) {
            paragraph = paragraph?.nextParagraph(0);
            if (paragraph) {
              paragraphs.push(paragraph);
              paragraph.indent(indent + 10);
              paragraph.append(
                i18next.t('Construct.other.attribute') + ': ',
                new FontOptions(fontSize, FontType.Bold),
              );
              paragraph.append(
                talent.attributes
                  .filter((a) => a != null)
                  .map((a) =>
                    i18next.t(makeKey('Construct.attribute.', Attribute[a])),
                  )
                  .join(', '),
                new FontOptions(fontSize),
              );
            ...
            talent.talent.name === TALENT_NAME_MISSION_POD &&
            talent.missionPod != null
          ) {
            paragraph = paragraph?.nextParagraph(0);
            if (paragraph) {
              paragraphs.push(paragraph);
              paragraph.indent(indent + 10);
              paragraph.append(
                i18next.t('Construct.other.missionPod') + ': ',
                new FontOptions(fontSize, FontType.Bold),
              );
              paragraph.append(
                talent.missionPod.localizedName,
                new FontOptions(fontSize),
              );
            }
          } else if (
            ...
            if (paragraph) {
              ...
              paragraph.indent(indent + 10);
              paragraph.append(
                propulsion?.localizedName,
                new FontOptions(fontSize),
              );
            }
          } else if (
            talent.talent.name === TALENT_NAME_WARRIORS_SPIRIT &&
            talent.selection != null
          ) {
            paragraph = paragraph?.nextParagraph(0);
            if (paragraph) {
              ...
              paragraph.indent(indent + 10);
              paragraph.append(
                i18next.t('Construct.other.weapon') + ': ',
                new FontOptions(fontSize, FontType.Bold),
              );
              paragraph.append(
                i18next.t(
                  makeKey(
                    'SpecialWeapon.',
                    SpecialWeapon[talent.selection as SpecialWeapon],
                  ),
                ),
                new FontOptions(fontSize),
              );
            ...
            talent.talent.name === TALENT_NAME_DEFENSIVE_TRAINING &&
            talent.selection != null
          ) {
            paragraph = paragraph?.nextParagraph(0);
            if (paragraph) {
              ...
              paragraph.indent(indent + 10);
              paragraph.append(
                i18next.t('Construct.other.attackType') + ': ',
                new FontOptions(fontSize, FontType.Bold),
              );
              paragraph.append(
                i18next.t(
                  makeKey(
                    'Weapon.common.',
                    AttackType[talent.selection as AttackType],
                  ),
                ),
                new FontOptions(fontSize),
              );
            ...
            if (paragraph) {
              ...
              paragraph.indent(indent + 10);
              paragraph.append(
                i18next.t('Construct.other.department') + ': ',
                new FontOptions(fontSize, FontType.Bold),
              );
              paragraph.append(
                talent.departments
                  .map((d) =>
                    i18next.t(makeKey('Construct.discipline.', Department[d])),
                  )
                  .join(', '),
                new FontOptions(fontSize),
              );
            ...
            talent.talent.name === TALENT_NAME_DEDICATED_PERSONNEL &&
            talent.departments?.length
          ) {
            paragraph = paragraph?.nextParagraph(0);
            if (paragraph) {
            ...
            talent.talent.name === TALENT_NAME_REDUNDANT_SYSTEMS &&
            talent.selection != null
          ) {
            paragraph = paragraph?.nextParagraph(0);
            if (paragraph) {
            ...
            if (paragraph) {
              ...
              paragraph.append(
                i18next.t(makeKey('Construct.system.', System[talent.system])),
                new FontOptions(fontSize),
              );
            }
          } else if (
            ...
            if (talent.system != null) {
              ...
              if (paragraph) {
                ...
                paragraph.indent(indent + 10);
                paragraph.append(
                  i18next.t('Construct.other.systems') + ': ',
                  new FontOptions(fontSize, FontType.Bold),
                );
                paragraph.append(
                  i18next.t(
                    makeKey('Construct.system.', System[talent.system]),
                  ),
                  new FontOptions(fontSize),
                );
              }
