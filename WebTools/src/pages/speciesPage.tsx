          ...
          <tbody>
            ...
            >
              ...
              <td className="d-none d-sm-table-cell text-end">
                <Button size="sm" onClick={() => showCustomSpecies()}>
      ...
      <div className="container ms-0">
        ...
        <main>
          ...
          <div
            ...
            role="group"
            aria-label={t('Page.title.species')}
          >
            <button
              type="button"
              className={
                'btn btn-info btn-sm p-2 text-center ' +
                (tab === SpeciesTab.Standard ? 'active' : '')
              }
              onClick={() => setTab(SpeciesTab.Standard)}
            >
              {t('SpeciesPage.standardSpecies')}
            </button>
            <button
              type="button"
              className={
                'btn btn-info btn-sm p-2 text-center ' +
                (tab === SpeciesTab.Mixed ? 'active' : '')
              }
              onClick={() => setTab(SpeciesTab.Mixed)}
            >
              {t('SpeciesPage.mixedSpecies')}
            </button>
            <button
              type="button"
              className={
                'btn btn-info btn-sm p-2 text-center ' +
                (tab === SpeciesTab.Custom ? 'active' : '')
              }
              onClick={() => setTab(SpeciesTab.Custom)}
            >
