...
> = ({ era, starship }) => {
  ...
  const [randomSpaceframe, setRandomSpaceframe] = useState(
    starship?.spaceframeModel?.id,
  );

  let selectionList = SpaceframeHelper.instance()
    .soloSpaceframesByEra(era)
    .map((s) => SpaceframeHelper.instance().getSpaceframe(s));
  ...
  const selectionRows = selectionList.map((s, i) => {
    const departments = (
      <>
        <StatView
          ...
          value={s.soloStats?.departments[Department.Command]}
          className="col mb-1"
          showZero={true}
        ...
        <StatView
          ...
          value={s.soloStats?.departments[Department.Security]}
          className="col mb-1"
          showZero={true}
        ...
        <StatView
          ...
          value={s.soloStats?.departments[Department.Science]}
          className="col mb-1"
          showZero={true}
        ...
        <StatView
          ...
          value={s.soloStats?.departments[Department.Conn]}
          className="col mb-1"
          showZero={true}
        ...
        <StatView
          ...
          value={s.soloStats?.departments[Department.Engineering]}
          className="col mb-1"
          showZero={true}
        ...
        <StatView
          ...
          value={s.soloStats?.departments[Department.Medicine]}
          className="col mb-1"
          showZero={true}
    ...
    const systems = (
      <>
        <StatView
          ...
          value={s.soloStats?.systems[System.Comms]}
          className="col mb-1"
          showZero={true}
        ...
        <StatView
          ...
          value={s.soloStats?.systems[System.Engines]}
          className="col mb-1"
          showZero={true}
        ...
        <StatView
          ...
          value={s.soloStats?.systems[System.Structure]}
          className="col mb-1"
          showZero={true}
        ...
        <StatView
          ...
          value={s.soloStats?.systems[System.Computer]}
          className="col mb-1"
          showZero={true}
        ...
        <StatView
          ...
          value={s.soloStats?.systems[System.Sensors]}
          className="col mb-1"
          showZero={true}
        ...
        <StatView
          ...
          value={s.soloStats?.systems[System.Weapons]}
          className="col mb-1"
          showZero={true}
    ...
    return (
      <tr
        key={i}
        onClick={() => {
          if (Window.isCompact()) selectSpaceframe(s);
        }}
      >
        ...
        <td className="d-none d-md-table-cell">
          ...
          <div
            className="row row-cols-1 row-cols-lg-3 mt-2"
            style={{ maxWidth: '600px' }}
          >
            {departments}
          </div>
          <div
            className="row row-cols-1 row-cols-lg-3 mt-2 mb-3"
            style={{ maxWidth: '600px' }}
          >
            <StatView
  ...
  return (
    <div className="page container ms-0">
      <SoloStarshipBreadcrumbs
        pageIdentity={PageIdentity.SoloStarshipSpaceframe}
      />
      ...
      <div className="my-4">
        ...
        {randomSpaceframe != null ? (
          <Button
            size="sm"
            className="me-3"
            onClick={() => setRandomSpaceframe(null)}
          >
