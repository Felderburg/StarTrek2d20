...
const SoloEarlyOutlookDetailsPage: React.FC<ICharacterProperties> = ({
  ...
  const attributes = character.upbringingStep?.acceptedUpbringing ? (
    <div>
      <AttributeView
        name={AttributesHelper.getAttributeName(
    ...
    <div>
      <AttributeView
        name={AttributesHelper.getAttributeName(
          earlyOutlook.attributeRebelPlus2,
        )}
        points={2}
      ...
      <AttributeView
        name={AttributesHelper.getAttributeName(
          earlyOutlook.attributeRebelPlus1,
        )}
        points={1}
    ...
    <div className="page container ms-0">
      ...
      <div className="row">
        <div className="col-lg-6 my-3">
          <Header level={2}>
            <>
              {t('Construct.other.disciplines')} ({t('Common.text.selectOne')})
            </>
          </Header>
