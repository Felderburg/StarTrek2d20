...
const SoloFinalPage: React.FC<ICharacterProperties> = ({ character }) => {
  ...
  let assignment: string | Role = character.role
    ? RolesHelper.instance.getRoleByName(character.role)
    : null;

  const [showAssignmentOther, setShowAssignmentOther] = useState(
  ...
  const assignmentOptions = () => {
    ...
    [
      ...
      result.push(
        new DropDownElement(r, RolesHelper.instance.getSoloRole(r).name),
      ),
    );
    return result;
  };
  ...
  const rankOptions = () => {
    ...
    [
      ...
      result.push(
        new DropDownElement(r, RanksHelper.instance().getRank(r).name),
      ),
    );
    return result;
  };
  ...
  return (
    <div className="page container ms-0">
      ...
      <div className="row">
        ...
        <div className="col-md-6 my-3">
          ...
          <DropDownSelect
            ...
            onChange={(r) => assignmentSelected(r)}
          />
          ...
          {showAssignmentOther ? (
            <div>
              <InputFieldAndLabel
                id="assignmentOther"
                labelName={t('Construct.other.assignment')}
        ...
        {character.isCivilian() ? undefined : (
          <div className="col-md-6 my-3">
            <Header level={2} className="mb-3">
      ...
      <div className="button-container my-5">
        ...
        <Button size="sm" className="me-3" onClick={() => showViewPage()}>
