    ...
    if (pageIdentity === PageIdentity.SoloStarshipSpaceframe) {
      return (
        <li className="breadcrumb-item active" aria-current="page">
          {t('Page.title.spaceframeSelection')}
        </li>
      );
      ...
      return (
        <li className="breadcrumb-item">
          <a
            href="/index.html"
            onClick={(e) => navigateTo(e, PageIdentity.SoloStarshipSpaceframe)}
          >
            {t('Page.title.spaceframeSelection')}
          </a>
        </li>
    ...
    if (pageIdentity === PageIdentity.SoloStarshipTalents) {
      ...
      return (
        <li className="breadcrumb-item">
          <a
            href="/index.html"
            onClick={(e) => navigateTo(e, PageIdentity.SoloStarshipTalents)}
          >
            {t('Construct.other.talents')}
          </a>
        </li>
    ...
    <nav aria-label="breadcrumb">
      <ol className="breadcrumb">
        ...
        <li className="breadcrumb-item">
          <a
            href="/index.html"
            onClick={(e) => navigateTo(e, PageIdentity.SoloStarshipEra)}
          >
            {t('Page.title.era')}
          </a>
        </li>
