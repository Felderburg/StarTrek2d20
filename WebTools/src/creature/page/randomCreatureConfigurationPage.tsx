...
> = ({ era }) => {
  ...
  const getHabitatTypes = () => {
    ...
    result.push(
      ...HabitatHelper.instance
        .getTypes()
        .filter(
          (h) =>
            creatureType == null ||
            habitatsByCreatureType(creatureType).includes(h.id),
        )
  ...
  const getCreatureTypes = () => {
    ...
    result.push(
      ...CreatureTypeHelper.instance
        .getTypes()
        .map((c) => new DropDownElement(c.id, c.localizedName)),
    );
    return result;
  };
          ...
          <main>
            ...
            <div className="row">
              <div className="col-md-6 mt-4">
                <Header level={2}>
                  {t('RandomCreatureConfiguration.habitat')}
                </Header>
                ...
                <div className="my-4">
                  <DropDownSelect
                    ...
                    onChange={(type) =>
                      setHabitat(type === '' ? undefined : (type as Habitat))
                    }
                  />
                </div>
              </div>
              ...
              <div className="col-md-6 mt-4">
                <Header level={2}>
                  {t('Construct.creature.creatureType')}
                </Header>
