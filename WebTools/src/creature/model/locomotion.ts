...
export const generateRandomLocomotionType = (
  type: CreatureType,
  habitat: Habitat,
) => {
  switch (type) {
      ...
      switch (D20.roll()) {
        ...
        case 7:
          return [
            new LocomotionModel(
              LocomotionTypeHelper.instance.getTypeById(
                LocomotionType.Tentacles,
              ),
              2 + Math.floor(D20.roll() / 2),
            ),
          ];
        case 8:
        case 9:
        ...
        case 11:
          return [
            new LocomotionModel(
              LocomotionTypeHelper.instance.getTypeById(LocomotionType.Legs),
              4,
            ),
          ];
        case 12:
      ...
      switch (D20.roll()) {
        ...
        case 5:
          return [
            ...
            new LocomotionModel(
              LocomotionTypeHelper.instance.getTypeById(LocomotionType.Wings),
              4,
            ),
          ];
        case 6:
    ...
    case CreatureType.Plant: {
      return [
        new LocomotionModel(
          LocomotionTypeHelper.instance.getTypeById(LocomotionType.Roots),
          2 + Math.floor(D20.roll() / 2),
        ),
      ];
    }
    case CreatureType.Fish:
      switch (D20.roll()) {
        ...
        case 13:
          return [
            new LocomotionModel(
              LocomotionTypeHelper.instance.getTypeById(LocomotionType.Fins),
              2,
            ),
          ];
        case 14:
