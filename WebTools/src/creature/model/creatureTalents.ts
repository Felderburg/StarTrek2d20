...
export const generateRandomBasicCreatureTalent = () => {
  switch (D20.roll()) {
    ...
    case 20:
      let result = appendWithNoDuplicates(
        [],
        generateRandomBasicCreatureTalent(),
      );
      result = appendWithNoDuplicates(
        result,
        generateRandomBasicCreatureTalent(),
      );
      return result;
  ...
  switch (diet) {
    ...
    case DietType.MineralsOrMetal:
      switch (D20.roll()) {
        ...
        case 19:
          return [
            toSelection(TalentsHelper.getTalent('Sturdy (Special Rule)')),
          ];
        case 20:
          let result = appendWithNoDuplicates(
            [],
  ...
  switch (type) {
    case CreatureType.Bird:
      switch (D20.roll()) {
        ...
        case 17:
          return [
            toSelection(
              TalentsHelper.getTalent('Enhanced Attribute X'),
              'Blood Lust',
              2,
              Attribute.Daring,
            ),
    ...
    case CreatureType.Invertebrate:
      switch (D20.roll()) {
        ...
        case 5:
          return [
            toSelection(
              TalentsHelper.getTalent('Natural Protection X'),
              'Chitinous Shell',
              2,
            ),
          ];
        ...
        case 7:
          return [
            toSelection(
              TalentsHelper.getTalent('Toxic, Poisonous or Venomous'),
              'Poisonous',
            ),
          ];
        case 8:
          return [
            toSelection(TalentsHelper.getTalent('Flight'), 'Insect-like Wings'),
          ];
        case 9:
        case 10:
          return [
        ...
        case 17:
          return [
            toSelection(
              TalentsHelper.getTalent('Sense Spectrum'),
              '360-degree Vision',
            ),
          ];
        case 18:
    ...
    case CreatureType.Mammal:
      switch (D20.roll()) {
        ...
        case 8:
          return [
            toSelection(
              TalentsHelper.getTalent('Camouflaged X'),
              'Patterned Fur',
              1,
            ),
          ];
        ...
        case 10:
          return [
            toSelection(TalentsHelper.getTalent('Flight'), 'Leathery Wings'),
          ];
        case 11:
        case 12:
          return [
        ...
        case 18:
          return [
            toSelection(
              TalentsHelper.getTalent('Multi-Limbed'),
              'Prehensile Trunk',
            ),
          ];
        case 19:
    ...
    case CreatureType.Plant:
      switch (D20.roll()) {
        ...
        case 19:
          return [
            toSelection(TalentsHelper.getTalent('Pheromones (Creature)')),
          ];
        case 20:
          let result = appendWithNoDuplicates(
            [],
...
const determineAttributeIfNecessary = (
  talent: TalentModel,
  attribute?: Attribute,
) => {
