...
export const ReputationChangeView: React.FC<IReputationChangeViewProperties> = ({character, onNextStep, onPreviousStep}) => {
    ...
    return (<>
        <div className="row">
            <div className="col-12 col-md-6 mt-4">
                ...
                <Markdown className="mt-4">{t('ReputationChangePage.instruction')}</Markdown>
