            ...
            <tr>
                ...
                <td>
                    <div className="d-flex justify-content-end w-100">
                        <DropDownSelect items={getTypes()} defaultValue={value.useType}
                ...
                <td colSpan={2}>
                    <div className="row">
                        <div className="offset-md-1 col-12 col-md-6">
                            <ValueInputWithRandom labelName="New Value" value={value.newValue}
                                character={character}
                                onValueChanged={(v) => modifyNewValue(v)} id={"newValue-" + cyrb53(value.value)}/>
                        </div>
                    </div>
                </td>
            </tr>
