...
const UniformSelectionView: React.FC<IUniformSelectionViewProperties> = ({token, loadPack, isLoading}) => {
        ...
        return (<div className="mt-4">
            <div className="row align-items-start">
                <div className="col-lg-6 mb-3">
                    ...
                    <DropDownSelect items={uniformErasList()} defaultValue={token.uniformEra}
            ...
            <div className="d-flex flex-wrap" style={{gap: "0.5rem"}}>
            {UniformCatalog.instance.getSwatches(token.uniformEra, token.species).map(s => <SwatchButton svg={s.svg} title={s.localizedName} size="lg"
