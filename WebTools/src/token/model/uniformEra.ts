...
export class UniformEraHelper {
  ...
  types = [
    ...
    new UniformEraModel(
      UniformEra.MonsterMaroon,
      'The Wrath of Khan and Later Movies',
    ),
    new UniformEraModel(UniformEra.Prodigy, 'Prodigy'),
    new UniformEraModel(
      UniformEra.PicardRomulanEvacuation,
      'Picard (Romulan Evacuation)',
    ),
