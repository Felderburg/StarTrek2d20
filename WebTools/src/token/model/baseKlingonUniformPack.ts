  ...
  getRankSwatches() {
    return [
      new Swatch(
        Rank.None,
        'None',
        (token) => BaseKlingonUniformPack.decorateSwatch('', Rank.None, token),
        'Rank.none.name',
      ),
      new Swatch(
        Rank.Ensign,
        'Ensign',
        (token) =>
          BaseKlingonUniformPack.decorateSwatch(
            KlingonRanks.Border.Ensign,
            Rank.Ensign,
            token,
          ),
        'Rank.ensign.name',
      ...
      new Swatch(
        ...
        (token) =>
          BaseKlingonUniformPack.decorateSwatch(
            KlingonRanks.Border.LieutenantJG,
            Rank.LieutenantJG,
            token,
          ),
      ...
      new Swatch(
        ...
        (token) =>
          BaseKlingonUniformPack.decorateSwatch(
            KlingonRanks.Border.Lieutenant,
            Rank.Lieutenant,
            token,
          ),
      ...
      new Swatch(
        ...
        (token) =>
          BaseKlingonUniformPack.decorateSwatch(
            KlingonRanks.Border.LtCommander,
            Rank.LtCommander,
            token,
          ),
