...
const TacticalAssetsPage = () => {
  ...
  const generateAsset = () => {
    ...
    if (options.length > 0) {
      ...
      toast("Sorry. There aren't any more assets to choose from.", {
      ...
      <div id="app">
        <div className="page container ms-0">
            ...
            <ol className="breadcrumb">
              <li className="breadcrumb-item">
                <a
                  href="/index.html"
                  onClick={(e) =>
                    preventDefaultAnchorEvent(e, () => navigate('/'))
                  }
                >
                  {t('Page.title.home')}
                </a>
          ...
          <main>
            ...
            <p className="mt-3">{t('TacticalAssetsPage.instruction')}</p>
            ...
            <div className="my-3 text-end">
              <Button size="sm" onClick={() => generateAsset()}>
                Add
              </Button>
            </div>

            <Header level={2} className="mt-4">
              {t('TacticalAssetsPage.assets')}
            </Header>
              ...
              <table className="table table-dark mt-4">
                <thead>
                  <tr>
                    ...
                    <th className="bg-black d-none d-md-table-cell text-center">
                      {t('Construct.assetStat.medical')}
                    </th>
                    <th className="bg-black d-none d-md-table-cell text-center">
                      {t('Construct.assetStat.military')}
                    </th>
                    <th className="bg-black d-none d-md-table-cell text-center">
                      {t('Construct.assetStat.personal')}
                    </th>
                    <th className="bg-black d-none d-md-table-cell text-center">
                      {t('Construct.assetStat.science')}
                    </th>
                    <th className="bg-black d-none d-md-table-cell text-center">
                      {t('Construct.assetStat.social')}
                    </th>
                      ...
                      return (
                        <>
                          <tr key={'asset-' + i}>
                            <td rowSpan={2}>
                              <p>
                                {a.name} {getSpaceframe(a)}
                              </p>
                            </td>
                            <td className="d-none d-md-table-cell text-center border-bottom-0">
                              {a.stats[AssetStatType.Medical].asString}{' '}
                            </td>
                            <td className="d-none d-md-table-cell text-center border-bottom-0">
                              {a.stats[AssetStatType.Military].asString}{' '}
                            </td>
                            <td className="d-none d-md-table-cell text-center border-bottom-0">
                              {a.stats[AssetStatType.Personal].asString}{' '}
                            </td>
                            <td className="d-none d-md-table-cell text-center border-bottom-0">
                              {a.stats[AssetStatType.Science].asString}{' '}
                            </td>
                            <td className="d-none d-md-table-cell text-center border-bottom-0">
                              {a.stats[AssetStatType.Social].asString}{' '}
                            </td>
                            <td
                              rowSpan={2}
                              className="text-end d-none d-md-table-cell"
                            >
                              <Button size="sm" onClick={() => showViewPage(a)}>
                          ...
                          <tr>
                            <td
                              colSpan={5}
                              className="d-none d-md-table-cell border-top-0"
                            >
