...
const AssetAbilityView: React.FC<IAssetAbilityViewProperties> = ({
  ability,
}) => {
  if (ability == null) {
    return undefined;
...
const AssetView: React.FC<IAssetViewProperties> = ({ asset }) => {
  ...
  const exportPdf = async () => {
    ...
    import(/* webpackChunkName: 'export' */ '../../exportpdf/spaderCard').then(
      async ({ SpaderCard }) => {
        setLoadingExport(false);

        const card = new SpaderCard();

        const existingPdfBytes = await fetch(card.getPdfUrl(asset)).then(
          (res) => res.arrayBuffer(),
        );
    ...
    <main>
      ...
      <div className="row mt-4">
        <div className="col-12 col-xl-6">
          <div className="row">
            <div className="col-4 view-field-label pb-2">
              {t('Construct.other.name')}:
            </div>
            <div className="col-8 text-white">
              <div className="view-border-bottom pb-2">{asset.name}</div>
            </div>
          </div>

          <div className="row">
            <div className="col-4 view-field-label pb-2">
              {t('Construct.other.assetType')}:
            </div>
            <div className="col-8 text-white">
              <div className="view-border-bottom pb-2">
                {AssetTypes.instance.getTypes()[asset.type].name}
              </div>
            </div>
          </div>

          {asset.additionalInformation != null &&
          asset.type === AssetType.Ship ? (
            <div className="row">
              <div className="col-4 view-field-label pb-2">
              ...
              <div className="col-8 text-white">
                <div className="view-border-bottom pb-2">
                  {
                    SpaceframeHelper.instance().getSpaceframe(
          ...
          asset.type === AssetType.Character ? (
            <div className="row">
              ...
              <div className="col-8 text-white">
                <div className="view-border-bottom pb-2">
                  {
                    RanksHelper.instance().getRank(
                      asset.additionalInformation as Rank,
                    ).localizedName
                  }
                </div>
              </div>
          ...
          <div className="row row-cols-3 row-cols-md-6 justify-content-md-center">
            <div className="col">
              <div className="bg-primary text-center py-3 my-3 rounded-3">
                <div className="text-white">
                  <small>{t('Construct.assetStat.medical')}</small>
                </div>
            ...
            <div className="col">
              <div className="bg-primary text-center py-3 my-3 rounded-3">
                <div className="text-white">
                  <small>{t('Construct.assetStat.military')}</small>
                </div>
            ...
            <div className="col">
              <div className="bg-primary text-center py-3 my-3 rounded-3">
                <div className="text-white">
                  <small>{t('Construct.assetStat.personal')}</small>
                </div>
            ...
            <div className="col">
              <div className="bg-primary text-center py-3 my-3 rounded-3">
                <div className="text-white">
                  <small>{t('Construct.assetStat.science')}</small>
                </div>
            ...
            <div className="col">
              <div className="bg-primary text-center py-3 my-3 rounded-3">
                <div className="text-white">
                  <small>{t('Construct.assetStat.social')}</small>
                </div>
