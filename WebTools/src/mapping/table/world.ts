  ...
  static getTypes() {
    if (this.types == null) {
      this.types = [
        ...
        new RingTypeModel(
          RingType.AsteroidBelt,
          'Asteroid Belt of small moons and moonlets',
        ),
      ];
    }
    return this.types;
...
export class AsteroidBeltDetails extends WorldDetails {
  ...
  plainText() {
    return (
      ...
      (this.asteroidSize != null
        ? '\nPredominant Size: ' +
          (this.asteroidSize >= 1000
            ? (this.asteroidSize / 1000).toFixed(0) + 'km'
            : this.asteroidSize.toFixed(0) + 'm') +
          ' Diameter'
        : '')
    );
  }
  ...
  get attributeList() {
    ...
    if (this.asteroidSize != null) {
      result.push(
        new WorldAttribute(
          i18next.t('World.attribute.predominantSize'),
          (this.asteroidSize >= 1000
            ? (this.asteroidSize / 1000).toFixed(0) + 'km'
            : this.asteroidSize.toFixed(0) + 'm') + ' Diameter',
        ),
      );
    }
    if (this.depth != null) {
      result.push(
        new WorldAttribute(
          i18next.t('World.attribute.beltWidth'),
          this.depth.toFixed(2) + ' AUs',
        ),
      );
    }
    ...
    if (this.nickelIronPercent > 0) {
      result.push(
        new WorldAttribute(
          'Inner Belt',
          (this.nickelIronPercent * this.depth).toFixed(2) +
            ' AUs (nickel-iron)',
        ),
      );
    }
    result.push(
      new WorldAttribute(
        'Mixed Belt',
        (this.mixedPercent * this.depth).toFixed(2) + ' AUs (mixed)',
      ),
    );
    result.push(
      new WorldAttribute(
        'Outer Belt',
        (this.carbonaceousOrIcePercent * this.depth).toFixed(2) +
          ' AUs (carbonaceous and/or ice)',
      ),
    );
...
export class GasGiantDetails extends WorldDetails {
  ...
  public static createBasicDistributionOfMoons(gasGiant: World) {
    ...
    if (gasGiant?.worldClass?.id === WorldClass.J) {
      ...
      gasGiant?.worldClass?.id === WorldClass.T ||
      gasGiant.worldClass.id === WorldClass.I
    ) {
      modifier = 2;
    }
    result.moonlets =
      Math.ceil(D20.roll() / 2) + Math.ceil(D20.roll() / 2) + modifier;
    result.smallMoons =
      Math.ceil(D20.roll() / 4) + Math.ceil(D20.roll() / 4) + modifier;
  ...
  public get satelliteDetails() {
    if (
      ...
      return (
        this.mediumMoons +
        ' medium moons' +
        (this.ring?.id !== RingType.AsteroidBelt
          ? ', ' +
            this.smallMoons +
            ' small moons, ' +
            this.moonlets +
  ...
  get attributeList() {
    ...
    result.push(
      new WorldAttribute(
        ...
        this.satelliteDetails,
      ),
    );
    if (this.ring != null) {
      result.push(
        new WorldAttribute(i18next.t('World.attribute.ring'), this.ring.name),
      );
    }
    return result;
  }
...
export class StandardWorldDetails extends WorldDetails {
  ...
  get attributeList() {
    ...
    if (this.tidallyLocked != null) {
      result.push(
        new WorldAttribute(
          i18next.t('World.attribute.rotation'),
          i18next.t('World.attribute.tidallyLocked'),
        ),
      );
      ...
      result.push(
        new WorldAttribute(
          ...
          this.rotationPeriod.toFixed(2) +
            ' hours' +
            (this.retrograde
              ? ' (' + i18next.t('World.attribute.retrograde') + ')'
              : ''),
        ),
      );
    }
    if (this.axialTilt != null) {
      result.push(
        new WorldAttribute(
          i18next.t('World.attribute.axialTilt'),
          this.axialTilt.toFixed(2) + '\u{b0}',
        ),
      );
    }
    if (this.hydrographicPercentage != null) {
      result.push(
        new WorldAttribute(
          i18next.t('World.attribute.waterCoverage'),
          this.hydrographicPercentage.toFixed(2) + '%',
        ),
      );
    }
...
export class World {
  ...
  get orbitId() {
    return (
      '' +
      this.orbitNumber +
      (this.satelliteOrbit == null ? '' : ALPHABET.charAt(this.satelliteOrbit))
    );
  }
  ...
  get orbitLabel() {
    return this.orbit == null
      ? undefined
      : RomanNumerals[this.orbit] +
          (this.satelliteOrbit == null
            ? ''
            : ALPHABET.charAt(this.satelliteOrbit));
  }
  ...
  get plainText() {
    return (
      ...
      (this.worldClass
        ? '\nClassification: ' +
          (this.worldClass.id === WorldClass.AsteroidBelt
            ? 'Asteroid Belt'
            : 'Class ' +
              WorldClass[this.worldClass.id] +
              ' (' +
              this.worldClass.description +
              ')')
        : '') +
      (this.worldClass.id !== WorldClass.AsteroidBelt
        ...
        : '') +
      '\nOrbital Radius: ' +
      this.orbitalRadius.toFixed(2) +
      ' AUs' +
      '\nOrbital Period: ' +
      this.period.toFixed(3) +
      ' Earth Years' +
      (this.diameter != null
        ? '\nDiameter: ' +
          Math.round(this.diameter).toLocaleString('en-US') +
          ' km'
        : '') +
      (this.density != null
      ...
      (this.mass != null
        ? '\nMass: ' +
          (this.mass >= 1000
            ? Math.round(this.mass).toLocaleString('en-US')
            : this.mass.toFixed(2)) +
          ' Earth'
        : '') +
      (this.gravity != null
  ...
  get attributeList() {
    ...
    if (this.orbitLabel != null) {
      result.push(
        new WorldAttribute(
          i18next.t('World.attribute.designation'),
          this.orbitLabel,
        ),
      );
    }
    ...
    if (this.worldClass.id === WorldClass.AsteroidBelt) {
      result.push(
        new WorldAttribute(
          i18next.t('World.attribute.classification'),
          'Asteroid Belt',
        ),
      );
      ...
      result.push(
        new WorldAttribute(
          i18next.t('World.attribute.classification'),
          i18next.t('World.class.fullDescription', {
    ...
    if (this.notes?.length) {
      result.push(
        new WorldAttribute(
          i18next.t('World.attribute.notes'),
          this.notes.join(', '),
        ),
      );
    }
    ...
    if (this.isSatellite) {
      result.push(
        new WorldAttribute(
          i18next.t('World.attribute.orbitalRadius'),
          Math.round(this.satelliteOrbitalRadius).toLocaleString('en-US') +
            ' km',
        ),
      );
      if (this.period != null) {
        result.push(
          new WorldAttribute(
            i18next.t('World.attribute.orbitalPeriod'),
            this.period.toFixed(3) + ' Earth Years',
          ),
        );
      }
    } else {
      result.push(
        new WorldAttribute(
          i18next.t('World.attribute.orbitalRadius'),
          this.orbitalRadius.toFixed(2) + ' AUs',
        ),
      );
      if (this.period != null) {
        result.push(
    ...
    if (this.orbitalEccentricity != null) {
      result.push(
        new WorldAttribute(
          i18next.t('World.attribute.eccentricity'),
          this.orbitalEccentricity.toFixed(3),
        ),
      );
    }
    ...
    if (this.diameter != null) {
      result.push(
        new WorldAttribute(
          i18next.t('World.attribute.diameter'),
          Math.round(this.diameter).toLocaleString('en-US') + ' km',
        ),
      );
    }
    if (this.density != null) {
      result.push(
        new WorldAttribute(
          i18next.t('World.attribute.density'),
          this.density.toFixed(2) + ' Earth',
        ),
      );
    }
    if (this.mass != null) {
      result.push(
        new WorldAttribute(
          i18next.t('World.attribute.mass'),
          (this.mass > 1000
            ? Math.round(this.mass).toLocaleString('en-US')
            : this.mass.toFixed(2)) + ' Earth',
        ),
      );
    }
    if (this.gravity != null) {
      result.push(
        new WorldAttribute(
          i18next.t('World.attribute.gravity'),
          this.gravity.toFixed(2) + ' G',
        ),
      );
    }
    ...
    if (
      ...
      result.push(
        new WorldAttribute(
          i18next.t('World.attribute.satellites'),
          this.numberOfSatellites.toFixed(0),
        ),
      );
    }
    if (this.coreType != null) {
      result.push(
        new WorldAttribute(
          i18next.t('World.attribute.core'),
          WorldCoreType[this.coreType],
        ),
      );
    }
      ...
      const features = this.features
        .map((f) =>
          typeof f === 'string' || f instanceof String
            ? f
            : f.localizedDescription,
        )
        .join(', ');
      result.push(
        new WorldAttribute(i18next.t('World.attribute.features'), features),
      );
    }
    return result;
  }
