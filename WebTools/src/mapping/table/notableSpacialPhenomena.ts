...
export class NotableSpatialPhenomenonModel {
    ...
    private static phenomenon = [
        ...
        new NotableSpatialPhenomenonModel(NotableSpatialPhenomenon.IonStormClass3, "Ion Storm, Class 3"),
        new NotableSpatialPhenomenonModel(NotableSpatialPhenomenon.IonStormClass4, "Ion Storm, Class 4"),
        ...
        new NotableSpatialPhenomenonModel(NotableSpatialPhenomenon.RadiationStormClass2, "Radiation Storm, Class 1"),
        new NotableSpatialPhenomenonModel(NotableSpatialPhenomenon.RadiationStormClass2, "Radiation Storm, Class 2"),
        ...
        new NotableSpatialPhenomenonModel(NotableSpatialPhenomenon.StellarFlareClass3, "Stellar Flare, Class 3"),
        new NotableSpatialPhenomenonModel(NotableSpatialPhenomenon.StellarFlareClass4, "Stellar Flare, Class 4"),
