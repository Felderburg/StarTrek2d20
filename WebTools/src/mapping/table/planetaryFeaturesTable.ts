...
export const planetaryFeaturesOfInterest: TableRoll<
  StandardPlantaryFeature
> = () => {
  switch (D20.roll()) {
    case 1:
    case 2:
...
class ColonyFeatureRegistry {
  ...
  private items: ColonyFeatureModel[] = [
    new ColonyFeatureModel(
      ColonyFeature.MiningColony,
      'An industrial mining colony',
    ),
    new ColonyFeatureModel(
      ColonyFeature.HuntingAndTrackingLodge,
      'A small lodge for hunting and tracking',
    ),
    new ColonyFeatureModel(
      ColonyFeature.MaroonedSurviverColony,
      'An adhoc colony formed by survivers of a crashed ship',
    ),
    new ColonyFeatureModel(
      ColonyFeature.ResearchStation,
      'A scientific research station',
    ),
    new ColonyFeatureModel(
      ColonyFeature.MilitaryBase,
      'A Military base, barracks, or outpost',
    ),
    new ColonyFeatureModel(
      ColonyFeature.EarlySpaceExplorationStation,
      "A habitat from a world's early space exploration program",
    ),
    new ColonyFeatureModel(ColonyFeature.TerraformingBase, 'Terraforming base'),
    new ColonyFeatureModel(
      ColonyFeature.CommercialBase,
      'A commercial base (e.g.: a deep space store or shopping mall)',
    ),
    new ColonyFeatureModel(ColonyFeature.PirateBase, 'A secret pirate base'),
    new ColonyFeatureModel(
      ColonyFeature.CommunicationsStation,
      'A communications station (a subspace repeater station or possibly a listening post)',
    ),
  ];
...
export const isolatedColonyFeaturesOfInterest: TableRoll<
  PlanetaryFeature
> = () => {
  switch (D20.roll()) {
    case 1:
      return ColonyFeatureRegistry.instance.getByType(
        ColonyFeature.HuntingAndTrackingLodge,
      );
    case 2:
    case 3:
    ...
    case 16:
      return ColonyFeatureRegistry.instance.getByType(
        ColonyFeature.TerraformingBase,
      );
    case 17:
      return ColonyFeatureRegistry.instance.getByType(
        ColonyFeature.CommunicationsStation,
