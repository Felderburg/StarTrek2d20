...
import { StandardWorldDetails } from '../table/world';
...
class SystemMapLowerView extends SystemMapView {
  render() {
        ...
        star2 = system?.companionStar?.spectralClass?.isDwarf ? (
          <g>
            <circle
              ...
              cy="110px"
              r={coronaR}
              fill="url(#companionStarCoronaRadialGradient)"
            />
            <circle
              cx={35 + r}
              cy="110px"
              r={r2}
              fill="url(#companionStarRadialGradient)"
              stroke="black"
              strokeWidth={0.5}
            />
            <text
              x={35 + r}
              y={110 + Math.max(r, r2) + 20}
              fontSize={14}
              fontFamily="lcars"
              fill="white"
              textAnchor="middle"
          ...
          <g>
            ...
            <text
              x={35 + r}
              y={110 + Math.max(r2, r) + 36}
              fontSize={16}
              fontFamily="lcars"
              fill="white"
              textAnchor="middle"
            >
              {system.companionStar?.spectralClass?.colourDescription?.toLocaleUpperCase()}
            </text>
          </g>
        );
        companionGradient = (
          <>
            <linearGradient id="companionStarCoronaLinearGradient">
              <stop
                stopColor={system.companionStar.spectralClass?.colour?.asHex()}
                offset={0}
              />
              <stop
                stopColor={system.companionStar.spectralClass?.colour?.asHex()}
                offset={coronaRStop.toFixed(2)}
              />
              <stop
                stopColor={system.companionStar.spectralClass?.colour
                  ?.withAlpha(0)
                  .asHex()}
                offset={1}
              />
            ...
            <radialGradient
              id="companionStarRadialGradient"
              xlinkHref="#companionStarLinearGradient"
              cx={35 + r - 0.4 * r2}
              cy={110 - 0.4 * r2}
              fx={35 + r - 0.4 * r2}
              fy={110 - 0.4 * r2}
            ...
            />
            <radialGradient
              id="companionStarCoronaRadialGradient"
              xlinkHref="#companionStarCoronaLinearGradient"
              cx={35 + r}
              cy={110}
              fx={35 + r}
              fy={110}
    ...
    const worldGradients = system.worlds?.map((w, i) => {
      ...
      return (
        <radialGradient
          id={'worldRadialGradient' + i}
          xlinkHref="#worldLinearGradient"
          cx={orbitalX - 0.4 * r}
          cy={110 - 0.4 * r}
          fx={orbitalX - 0.4 * r}
          fy={110 - 0.4 * r}
    ...
    const worlds = system.worlds?.map((w, i) => {
      ...
      if (w.worldClass.id === WorldClass.AsteroidBelt) {
        ...
        return (
          <g key={'world-' + i}>
            <circle
              cx={this.calculateOrbitX(beltStart, orbits)}
              cy="108px"
              r={1}
              fill={purple}
            />
            <circle
              cx={this.calculateOrbitX(beltStartMidway, orbits)}
              cy="112px"
              r={1}
              fill={purple}
            />
            ...
            <circle
              cx={this.calculateOrbitX(beltEndMidway, orbits)}
              cy="114px"
              r={1}
              fill={purple}
            />
            <circle
              cx={this.calculateOrbitX(beltEnd, orbits)}
              cy="110px"
              r={1}
              fill={purple}
            />
            ...
            {auWidth > 0 ? (
              <rect
                x={prevOrbitalX.toFixed(2)}
                y={0}
                height={20}
                width={auWidth.toFixed(2)}
                fill="#F9AC76"
              />
            ) : null}
            {auWidth > 30 ? (
        ...
        return (
          <g key={'world-' + i}>
            <circle
              ...
              cy="110px"
              r={r}
              fill={'url(#worldRadialGradient' + i + ')'}
            />
            {axis}
            <text
              x={orbitalX}
              y={i % 2 === 1 ? 110 + r + 20 : 110 - r - 26}
              fontSize={16}
              fontFamily="lcars"
              fill="white"
              textAnchor="middle"
    ...
    const starColour = system.star.spectralClass.colour.blend(
      new SimpleColor(255, 255, 255),
      0.5,
    );
    const darkerStarColour = system.star.spectralClass.colour.blend(
      new SimpleColor(0, 0, 0),
      0.4,
    );
    const worldColour = SimpleColor.from(purple).blend(
      new SimpleColor(255, 255, 255),
      0.5,
    );
    const darkerWorldColour = SimpleColor.from(purple).blend(
      new SimpleColor(0, 0, 0),
      0.2,
    );
    const companionColour = system.companionStar
      ? system.companionStar.spectralClass.colour.blend(
          new SimpleColor(255, 255, 255),
          0.5,
        )
      : null;
    const darkerCompanionColour = system.companionStar
      ? system.companionStar.spectralClass.colour.blend(
          new SimpleColor(0, 0, 0),
          0.5,
        )
        ...
        <svg viewBox="0 0 1110 230" xmlns="<http://www.w3.org/2000/svg>">
          <defs>
            <linearGradient id="primaryStarCoronaLinearGradient">
              ...
              />
              <stop
                stopColor={system.star.spectralClass?.colour
                  ?.withAlpha(0)
                  .asHex()}
                offset={1}
              />
            ...
            {companionColour ? (
              <linearGradient id="companionStarLinearGradient">
            ...
            <radialGradient
              id="primaryStarRadialGradient"
              xlinkHref="#primaryStarLinearGradient"
              cx={35 - 0.4 * r}
              cy={110 - 0.4 * r}
              fx={35 - 0.4 * r}
              fy={110 - 0.4 * r}
            ...
            />
            <radialGradient
              id="primaryStarCoronaRadialGradient"
              xlinkHref="#primaryStarCoronaLinearGradient"
              cx={35}
              cy={110}
              fx={35}
              fy={110}
          ...
          <path
            d="m 1025,80 v 96.71484 c 0.2996,18.56303 -4.3922,22.90266 -19.0273,23.28516 H 975 v 30 h 89.5605 c 32.0849,0.3825 45.7564,-14.25583 45.4395,-45 V 80 Z"
            fill="#F9AC76"
          />
          <path d="m 1025,30 v 40 h 85 V 30 Z" fill="#9999FF" />
          <path
            d="M 15 200 A 15 15 0 0 0 0 215 A 15 15 0 0 0 15 230 L 15 200 z "
            fill="#F9AC76"
          />
          <circle
            cx="35px"
            cy="110px"
            r={coronaR}
            fill="url(#primaryStarCoronaRadialGradient)"
          />
          <circle
            cx="35px"
            cy="110px"
            r={r}
            fill="url(#primaryStarRadialGradient)"
            stroke="black"
            strokeWidth={0.5}
          />
      ...
      return (
        <g>
          ...
          <rect
            ...
            y={200}
            height={30}
            width={(1050 - 2 - (outer + 2)).toFixed(2)}
            fill="#F9AC76"
          />
          <text
            x={inner - 6}
          ...
          {ecoWidth >= 54 ? (
            <text
              x={(inner + 2 + ecoWidth / 2).toFixed(2)}
              y={221}
              fontSize={16}
              fontFamily="lcars"
              fill="black"
          ...
          {lastAuMarker ? (
            <rect
              x={(lastAuMarker + 2).toFixed(2)}
              y={0}
              height={20}
              width={(1110 - (lastAuMarker + 2)).toFixed(2)}
              fill="#F9AC76"
            />
          ) : null}
        </g>
