  ...
  render() {
      ...
      if (system.companionType === CompanionType.Close) {
        ...
        star2 = system?.companionStar?.spectralClass?.isDwarf ? (
          <g>
            <circle
              ...
              cy={y2}
              r={coronaR}
              fill="url(#companionStarCoronaRadialGradientUp)"
            />
            <circle
              cx={35 + r}
              cy={y2}
              r={r2}
              fill="url(#companionStarRadialGradientUp)"
              stroke="black"
              strokeWidth={0.5}
            />
          </g>
        ...
        companionGradient = (
          <>
            ...
            <radialGradient
              id="companionStarRadialGradientUp"
              xlinkHref="#companionStarLinearGradientUp"
              cx={35 + r - 0.4 * r2}
              cy={y2 - 0.4 * r2}
              fx={35 + r - 0.4 * r2}
              fy={y2 - 0.4 * r2}
            ...
            />
            <radialGradient
              id="companionStarCoronaRadialGradientUp"
              xlinkHref="#companionStarCoronaLinearGradientUp"
              cx={35 + r}
              cy={y2}
              fx={35 + r}
              fy={y2}
    ...
    let worldGradients = system.worlds
      ...
      .map((w, i) => {
        ...
        return (
          <radialGradient
            id={'worldRadialGradientUp' + i}
            xlinkHref="#worldLinearGradientUp"
            cx={orbitalX - 0.4 * r}
            cy={y - 0.4 * r}
            fx={orbitalX - 0.4 * r}
            fy={y - 0.4 * r}
    ...
    let orbitalArcs = system.worlds?.map((w, i) => {
      ...
      if (w.worldClass.id === WorldClass.AsteroidBelt) {
        ...
        let arcs = allX.map((x1, index) => {
          ...
          return (
            <path
              d={this.createArcPath(radiusX1, radiusY1)}
              stroke="#ffffff"
              strokeWidth={2}
        ...
        return (
          <g key={'arc=' + i}>
            <path
              d={this.createArcPath(radiusX, radiusY)}
              stroke="#ffffff"
              strokeWidth={2}
              clipPath="url(#clipPath)"
              fill="none"
        ...
        return (
          <g key={'world-' + i}>
            ...
            <circle
              ...
              cy={y}
              r={r}
              fill={'url(#worldRadialGradientUp' + i + ')'}
            />
            <text
              x={x}
              y={y - r - 10}
    ...
    return (
      <div className="starSystemUpperView">
        <svg viewBox="0 0 1110 630" xmlns="<http://www.w3.org/2000/svg>">
          <defs>
            ...
            {companionColour ? (
              <linearGradient id="companionStarLinearGradientUp">
            ...
            <radialGradient
              id="primaryStarRadialGradientUp"
              xlinkHref="#primaryStarLinearGradientUp"
              cx={35 - 0.4 * r}
              cy={35 - 0.4 * r}
              fx={35 - 0.4 * r}
              fy={35 - 0.4 * r}
            ...
            />
            <radialGradient
              id="primaryStarCoronaRadialGradientUp"
              xlinkHref="#primaryStarCoronaLinearGradientUp"
              cx={35}
              cy={35}
              fx={35}
              fy={35}
          ...
          <path
            d="m 1025,0 v 150 h 85 V 45 c 0.3169,-30.744136 -13.3546,-45.38249962 -45.4395,-45 z"
            fill="#F9AC76"
          />
          ...
          <circle
            ...
            cy="35px"
            r={coronaR}
            fill="url(#primaryStarCoronaRadialGradientUp)"
          />
          <circle
            cx="35px"
            cy="35px"
            r={r}
            fill="url(#primaryStarRadialGradientUp)"
            stroke="black"
            strokeWidth={0.5}
          />
          {star2}
