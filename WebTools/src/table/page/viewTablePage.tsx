...
const ViewTablePageBase: React.FC<IViewTablePageProperties> = ({
  ...
  const showModal = () => {
    ModalControl.show(
      'lg',
      closeModal,
      <ShareTableModal link={createUrl()} />,
      'Share Table',
    );
  };
  ...
  const createUrl = () => {
    ...
    return (
      ...
      '/tools/table/import?table=' +
      TableMarshaller.instance.marshall(tableCollection)
    );
  };
            ...
            <main>
              ...
              <div className="row">
                <div className="col-md-6 mt-4">
                  <TableView
                    name={undefined}
                    table={tableCollection.mainTable}
                  />
                </div>
                ...
                <div className="col-md-6 mt-4">
                  <div className="text-end">
                    <Button
                      onClick={() => setValue(tableCollection.roll())}
                  ...
                  {value && value.length === 0
                    ? undefined
                    : value.map((v, i) => (
                        <div className="d-flex mt-4" key={'result-' + i}>
