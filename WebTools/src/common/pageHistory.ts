...
export function pushPage(history: PageIdentity[], currentPage: PageIdentity, nextPage: PageIdentity): PageIdentity[] {
...
export function popPage(history: PageIdentity[]): { page: PageIdentity; history: PageIdentity[] } | undefined {
    if (history.length === 0) {
        return undefined;
    }
...
export function workflowStepIndexForPage(workflow: ShipBuildWorkflow | undefined, page: PageIdentity): number | undefined {
    if (!workflow) {
        return undefined;
    }
