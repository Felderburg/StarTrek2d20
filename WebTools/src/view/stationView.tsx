...
const StationView: React.FC<IStationViewProperties> = ({station}) => {
    ...
    return (<main>
        ...
        <div className="row" style={{alignItems: "baseline"}}>
            ...
            <div className="col-md-4 text-white"><div className="view-border-bottom pb-2">{profile?.localizedName ?? NBSP}</div></div>
        </div>

        <div className="row" style={{alignItems: "baseline"}}>
            <div className="col-md-2 view-field-label pb-2">{t('Construct.other.traits')}:</div>
            <div className="col-md-10 text-white"><div className="view-border-bottom pb-2">{station.allTraitsAsString}</div></div>
        </div>
        ...
        <div className="row">
            <div className="col-xl-6 mt-4">
                ...
                <div className="row row-cols-1 row-cols-md-3 mt-3">
                    <StatView showZero={true} name={t(makeKey('Construct.system.', System[System.Comms]))} value={station.systems[System.Comms]} className="col mb-2" />
                    <StatView showZero={true} name={t(makeKey('Construct.system.', System[System.Engines]))} value={station.systems[System.Engines]} className="col mb-2" />
                    <StatView showZero={true} name={t(makeKey('Construct.system.', System[System.Structure]))} value={station.systems[System.Structure]} className="col mb-2" />
                    <StatView showZero={true} name={t(makeKey('Construct.system.', System[System.Computer]))} value={station.systems[System.Computer]} className="col mb-2" />
                    <StatView showZero={true} name={t(makeKey('Construct.system.', System[System.Sensors]))} value={station.systems[System.Sensors]} className="col mb-2" />
                    <StatView showZero={true} name={t(makeKey('Construct.system.', System[System.Weapons]))} value={station.systems[System.Weapons]} className="col mb-2" />
                </div>

                <Header level={2} className="mt-4">{t('Construct.other.departments')}</Header>
                <div className="row row-cols-1 row-cols-md-3 mt-3">
                    <StatView showZero={true} name={t(makeKey('Construct.department.', Department[Department.Command]))} value={station.departments ? station.departments[Department.Command] : undefined} className="col mb-2" />
                    <StatView showZero={true} name={t(makeKey('Construct.department.', Department[Department.Security]))} value={station.departments ? station.departments[Department.Security] : undefined} className="col mb-2" />
                    <StatView showZero={true} name={t(makeKey('Construct.department.', Department[Department.Science]))} value={station.departments ? station.departments[Department.Science] : undefined} className="col mb-2" />
                    <StatView showZero={true} name={t(makeKey('Construct.department.', Department[Department.Conn]))} value={station.departments ? station.departments[Department.Conn] : undefined} className="col mb-2" />
                    <StatView showZero={true} name={t(makeKey('Construct.department.', Department[Department.Engineering]))} value={station.departments ? station.departments[Department.Engineering] : undefined} className="col mb-2" />
                    <StatView showZero={true} name={t(makeKey('Construct.department.', Department[Department.Medicine]))} value={station.departments ? station.departments[Department.Medicine] : undefined} className="col mb-2" />
                </div>
