...
class CharacterProfile extends React.Component<ICharacterSheetProperties, {}> {
  render() {
    ...
    const getEnvironmentString = () => {
      let env = c.environmentStep
        ? EnvironmentsHelper.getEnvironment(c.environmentStep.environment, c)
            .localizedName
        : i18n.t('Common.text.none');

      if (
        c.environmentStep?.environment === Environment.AnotherSpeciesWorld &&
        c.environmentStep?.otherSpecies != null
      ) {
        env = CharacterSerializer.serializeEnvironment(
          c.environmentStep.environment,
          c.environmentStep.otherSpecies,
          c,
        );
      }
    ...
    let careerEvents = c.careerEvents.map((e, i) => {
      return (
        <div key={i}>
          {
            CareerEventsHelper.getCareerEvent(e.id, c.type, c.version)
              .localizedName
          }
        </div>
      );
    ...
    return (
      <div id="character-sheet">
        <div
          id="character-sheet"
          className={this.props.showProfile ? 'sheet-visible' : 'sheet-hidden'}
        >
          <div
            className="sheet-bg"
            id="sheet-bg"
            style={{ display: this.props.showProfile ? '' : 'none' }}
          ...
          <div className={containerClass} id="sheet-container">
            <div className="row">
                ...
                <>
                  <div className="col-md-6 mb-2">
                    <div className="sheet-panel d-flex">
                      ...
                      <div className="sheet-data">{c.name ?? ''}</div>
                    </div>
                  </div>
                  <div className="col-md-6 mb-2">
                    <div className="sheet-panel d-flex">
                      ...
                      <div className="sheet-data">{c.pronouns ?? ''}</div>
                    </div>
                  </div>
                </>
              ) : undefined}
              ...
              <div className="col-md-6 mb-2">
                <div className="sheet-panel d-flex">
                  <div className="sheet-label-purple text-uppercase">
                    {t('Construct.other.characterType')}
                  </div>
              ...
              <div className="col-md-6 mb-2">
                <div className="sheet-panel d-flex">
                  ...
                  <div className="sheet-data">{era?.localizedName ?? ''}</div>
                </div>
              </div>
              ...
              <div className="col-md-6 mb-2">
                <div className="sheet-panel d-flex">
                  ...
                  <div className="sheet-data">{c.assignment ?? ''}</div>
                </div>
              </div>
              ...
              <div className="col-md-6 mb-2">
                ...
                {c.version > 1 ? (
                  <div className="sheet-panel d-flex">
                    <div className="sheet-label-purple text-uppercase">
                      {t('Construct.other.speciesAbility')}
                    </div>
                    <div className="sheet-data">
                ...
                {c.stereotype === Stereotype.Npc ? undefined : (
                  <>
                    <div className="sheet-panel d-flex">
                      <div className="sheet-label-purple text-uppercase">
              ...
              <div className="col-md-6 mb-2">
                <div className="sheet-panel d-flex">
                  ...
                  <div className="sheet-data">{c.getAllTraits()}</div>
                </div>
                {c.stereotype === Stereotype.Npc ? undefined : (
                  <>
                    <div className="sheet-panel d-flex">
                      ...
                      <div className="sheet-data">
                        {c.upbringingStep?.localizedDescription ??
                          i18n.t('Common.text.none')}
                      </div>
                    </div>
                    <div className="sheet-panel d-flex">
                      <div className="sheet-label-purple text-uppercase">
                        {t('Construct.other.career')}
                      </div>
                      <div className="sheet-data">
                        {c.careerStep?.career != null
                          ? c.stereotype === Stereotype.SoloCharacter
                            ? CareersHelper.instance.getSoloCareerLength(
                                c.careerStep?.career,
                              ).localizedName
              ...
              <div className="col-md-6 mb-2">
                <div className="row">
                  ...
                  <div className="col-md-6">
                    <div className="sheet-panel d-flex mw-100">
                      <div className="sheet-label-purple text-uppercase">
                        {t('Construct.attribute.presence')}
                      </div>
                      <div className="sheet-data text-center">
              ...
              <div className="col-md-6 mb-2">
                <div className="sheet-panel d-flex">
                  ...
                  <div className="sheet-data">{values}</div>
                </div>
              </div>
              ...
              <div className="col-md-6 mb-2">
                <div className="sheet-panel d-flex">
                  ...
                  <div className="sheet-data">{focuses}</div>
                </div>
              ...
              <div className="col-md-6 mb-2">
                <div className="sheet-panel d-flex">
                  ...
                  <div className="sheet-data">{equipment}</div>
                </div>
              </div>
              ...
              {c.stereotype !== Stereotype.Npc ? (
                <div className="col-md-6 mb-2">
                  <div className="sheet-panel d-flex">
                    <div className="sheet-label-purple text-uppercase">
                      {t('Construct.other.careerEvents')}
                    </div>
                    <div className="sheet-data">{careerEvents}</div>
                  </div>
                </div>
              ) : undefined}
            </div>
