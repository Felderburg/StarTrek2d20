      ...
      <div className="row mt-3">
        ...
        <div className="col-xl-3 mb-2">
          <div className="d-flex align-items-start">
            <div className="pill-left pill-left-sm">
              <span className="delta">d</span>
            </div>
            <div className="pill-right pill-right-sm">
              <span>{dice}</span>
            </div>
          </div>
        </div>
        <div className="col-xl-12 mb-2">
          ...
          <div className="pill-right">{renderInjuryAndDetails()}</div>
        </div>
      </div>
    );
  } else {
