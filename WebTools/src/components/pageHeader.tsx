...
export const getPageTitle = (t, page) => {
  ...
  if (key !== t(key)) {
    ...
    page === PageIdentity.SoloSpecies ||
    page === PageIdentity.NpcSpeciesSelection
  ) {
    return t('Page.title.species');
  } else if (
    page === PageIdentity.SoloSpeciesDetails ||
    page === PageIdentity.NpcSpeciesSelectionDetails
  ) {
