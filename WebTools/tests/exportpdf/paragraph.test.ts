...
describe('testing line functions', () => {
  test('should append block', async () => {
    ...
    line.add(
      TextBlock.create('Text', new FontSpecification(helvetica, 9), false),
    );

    line.append(
      TextBlock.create(' Block', new FontSpecification(helvetica, 9), false),
    );
  ...
  test('should not append different block (colour)', async () => {
    ...
    line.append(
      TextBlock.create(
        ' Block',
        new FontSpecification(helvetica, 9),
        false,
        SimpleColor.from('#ff0000'),
      ),
    );
  ...
  test('should not append different block (font size)', async () => {
    ...
    line.append(
      TextBlock.create(' Block', new FontSpecification(helvetica, 10), false),
    );
