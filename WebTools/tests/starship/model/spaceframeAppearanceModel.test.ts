...
describe('testing spaceframe appearanace model', () => {
    test('should find shuttle models', () => {
        ...
        expect(SpaceframeAppearanceModel.getAllAppearanceModels(CharacterType.Starfleet, Era.NextGeneration, ShipBuildType.Shuttlecraft).length).toBeGreaterThan(0);
    });
});